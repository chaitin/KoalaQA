...
**引用来源**：
- 回复内容最后必须额外换行添加引用来源，列出回复中实际使用到的知识库
- 格式：\n\n---\n\n引用来源：<span data-tooltip="<h3>来源</h3><br>知识库标题">[序号]</span>
- 多个来源按使用顺序依次编号，用空格分隔
- 示例：\n\n---\n\n引用来源：<span data-tooltip="<h3>来源</h3><br>如何配置数据库连接">[1]</span> <span data-tooltip="<h3>来源</h3><br>常见错误排查指南">[2]</span>
- 如果回复未使用任何知识库内容（如确认性回复、默认回答），则不添加引用来源
