...
import {
  ContextResponse,
  DeleteAdminGroupGroupIdItemItemIdParams,
  GetAdminGroupGroupIdItemParams,
  ModelGroupItem,
  ModelListRes,
  PostAdminGroupGroupIdItemParams,
  PutAdminGroupGroupIdItemItemIdIndexParams,
  PutAdminGroupGroupIdItemItemIdParams,
  SvcGICreateReq,
  SvcGIUpdateIndexReq,
  SvcGIUpdateReq,
} from "./types";
...
export const getAdminGroupGroupIdItem = (
  { groupId, ...query }: GetAdminGroupGroupIdItemParams,
...
export const postAdminGroupGroupIdItem = (
  { groupId, ...query }: PostAdminGroupGroupIdItemParams,
  req: SvcGICreateReq,
  params: RequestParams = {},
) =>
  request<
...
export const putAdminGroupGroupIdItemItemId = (
  { groupId, itemId, ...query }: PutAdminGroupGroupIdItemItemIdParams,
  req: SvcGIUpdateReq,
  params: RequestParams = {},
) =>
...
export const deleteAdminGroupGroupIdItemItemId = (
  { groupId, itemId, ...query }: DeleteAdminGroupGroupIdItemItemIdParams,
  params: RequestParams = {},
) =>
  request<ContextResponse>({
    path: `/admin/group/${groupId}/item/${itemId}`,
...
export const putAdminGroupGroupIdItemItemIdIndex = (
  { groupId, itemId, ...query }: PutAdminGroupGroupIdItemItemIdIndexParams,
